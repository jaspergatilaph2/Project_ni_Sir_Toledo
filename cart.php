...
<html lang="pt-br">
  <head>
    ...
    />
    <title>.On Shop Variedades</title>
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@splidejs/splide@3.5.0/dist/css/splide.min.css"
    />
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@splidejs/splide@3.5.0/dist/css/themes/splide-skyblue.min.css"
    />
    <!-- splidejs CSS -->
  ...
  <body>
    ...
    <header>
      ...
      <div class="alert alert-primary" role="alert">
        <img
          src="assets/IMG/IMG/Icons/logo-pix-icone-256.png"
          width="20"
          height="20"
        />
      ...
      <section class="navbar navbar-expand-lg" id="navbar1">
        <div class="col-md-2" onclick="redirectBtnindex()" href="Login.html">
          <img
            src="../Online_Tech_Store_v1/assets/IMG/IMG/Logo/Online_Tech_Store.png"
            alt=""
            width=""
            height="75"
          />
      ...
      <!-- MODAL MOBILE -->
      <div
        class="modal animated slide-in-right"
        id="exampleModal"
        tabindex="-1"
              ...
              <div class="account-login">
                <span>
                  <ion-icon
                    ...
                    onclick="redirectBtnlogin()"
                    href="Login.html"
                  ></ion-icon>
                </span>
              </div>
              <div
                class="text menu-dropdown"
                onclick="redirectBtnlogin()"
                href="Login.html"
              >
                <span class="msg" onclick="redirectBtnlogin()" href="#"
                  >Welcome to</span
                >
                <a class="link" onclick="redirectBtnlogin()" href="#"
                  >Login or Register</a
                >
              </div>
              <button
            ...
            <div class="modal-body">
              ...
              <div class="modal-line" onclick="toggleDropdownMenu3()">
                ...
                >
                  ...
                  <li class="sidebar-dropdown-item">
                    <a href="#">Acessorios Apple</a>
                  </li>
                </ul>
              </div>
              <div class="modal-line" onclick="toggleDropdownMenu4()">
                <a href="#">Ofertas</a>
                <i class="bi bi-chevron-down" id="setmodal4"></i>
                <ul
                  id="dropdown-menu4"
                  class="sidebar-dropdown-menu"
                  style="display: none"
                >
                  <li class="sidebar-dropdown-item">
                    <a href="#">Subcategoria 01</a>
                  </li>
                  <li class="sidebar-dropdown-item">
                    <a href="#">Subcategoria 02</a>
                  </li>
                  <li class="sidebar-dropdown-item">
                    <a href="#">Subcategoria 03</a>
                  </li>
                  <li class="sidebar-dropdown-item">
                    <a href="#">Subcategoria 04</a>
                  </li>
                </ul>
              </div>
              <div class="modal-footer">
                <a target="_blank" href="#">
                  <i class="bi bi-whatsapp" id="whatsmodal"></i>
                </a>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <div class="align-items-start">
              <span class="Titledesktopsac">Sacola</span>
            </div>
            ...
            <div class="d-flex justify-content-between mt-3 pe-5 infoproduto">
              <div class="d-flex flex-row">
                <img
                  class="rounded"
                  src="assets/IMG/IMG/Products/PLACADEVIDEO2.jpg"
                  width="80"
                  height="80"
                />
                <div class="ml-2 ps-3">
                  <span class="d-block titledesktop"
                    >Apple iPhone 13 128GB (PRODUCT) RED Tela 6,1” 12MP - iOS
                    <br />
                    - Vermelho</span
                  >
                  <div class="mt-2">
                  ...
                  <div class="mt-1 mb-2">
                    <span class="entrega mt-4"
                      >Vendido e entregue por
                      <img src="assets/IMG/ON SHOP.jpg" width="70" alt=""
                    /></span>
                  </div>
                </div>
              </div>
            ...
            <div
              class="d-flex align-items-center justify-content-end pe-3 destoptotal"
            >
              <div class="row">
                ...
                <div class="d-flex justify-content-end">
                  ...
                  <span class="totaldesktopaymentcard mt-3">
                    ...
                    <a
                      class="btn btn-primary mt-3 mb-5 btndesktop"
                      href="#"
                      role="button"
                      >Continuar</a
                    >
          ...
          <div class="col-md-12">
            <div class="d-flex justify-content-between mt-3 p-2">
              <div class="d-flex flex-row">
                <img
                  class="rounded"
                  src="assets/IMG/IMG/Products/IMPRESSORA.jpg"
                  width="80"
                  height="80"
                />
                <div class="ml-2 desc">
            ...
            <div class="d-flex justify-content-between mt-3 p-2">
              <div class="d-flex flex-row">
                <img
                  class="rounded"
                  src="assets/IMG/IMG/Products/GELADEIRA.jpg"
                  width="80"
                  height="80"
                />
                <div class="ml-2 desc">
            ...
            <div class="d-flex justify-content-between mt-3 p-2">
              <div class="d-flex flex-row">
                <img
                  class="rounded"
                  src="assets/IMG/IMG/Products/NIKE.jpg"
                  width="80"
                  height="80"
                />
                <div class="ml-2 desc">
            ...
            <div class="total">
              <div class="payment-total">
                ...
                <img
                  class="paymentcard"
                  src="assets/IMG/IMG/Icons/elo.svg"
                  alt=""
                />
                <img
                  class="paymentcard"
                  src="assets/IMG/IMG/Icons/master.svg"
                  alt=""
                />
                <div class="total-checkout">
                  ...
                  <span class="condipricetotal">
                    ...
                    <a
                      class="btn btn-primary mb-0 mt-0 btncheckoutpayment"
                      href="#"
                      role="button"
                      >Continuar</a
                    >
                  ...
                  <ul class="list-unstyled">
                    <div class="media-icons" id="selos">
                      <div>
                        <a href="#"
                          ><img
                            src="assets/IMG/IMG/Icons/site seguro 2.png"
                            alt=""
                        /></a>
                      </div>
                      <div>
                        <a href="#"
                          ><img
                            src="assets/IMG/IMG/Icons/selo-google-res.png"
                            alt=""
                        /></a>
                      </div>
                      <div>
                        <a href="#"
                          ><img
                            src="assets/IMG/IMG/Icons/site prote.png"
                            alt=""
                        /></a>
                      </div>
                      <div>
                        <a href="#"
                          ><img
                            src="assets/IMG/IMG/Icons/siteseguro3.png"
                            alt=""
                        /></a>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="payment methods">
                        <a href="#"
                          ><img src="assets/IMG/IMG/Icons/visa.svg" alt=""
                        /></a>
                        <a href="#"
                          ><img src="assets/IMG/IMG/Icons/master.svg" alt=""
                        /></a>
                        <a href="#"
                          ><img src="assets/IMG/IMG/Icons/hipercard.svg" alt=""
                        /></a>
                        <a href="#"
                          ><img src="assets/IMG/IMG/Icons/boleto.svg" alt=""
                        /></a>
                        <a href="#"
                          ><img src="assets/IMG/IMG/Icons/elo.svg" alt=""
                        /></a>
                        <a href="#"
                          ><img src="assets/IMG/IMG/Icons/aura.svg" alt=""
                        /></a>
                        <a href="#"
                          ><img src="assets/IMG/IMG/Icons/diners.svg" alt=""
                        /></a>
                      </div>
                    </div>
                  </div>
