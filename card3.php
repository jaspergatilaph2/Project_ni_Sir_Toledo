  ...
  <div class="height d-flex justify-content-center align-items-center">
    <div class="card p-3">
      <div class="d-flex justify-content-between align-items-center">
        <div class="mt-2">
          <h4 class="text-uppercase">Mortal Kombat </h4>
          <h4 class="text-uppercase">11 - PS4</h4>
          <div class="mt-5">
        ...
        <div class="image">
          <img src="../Online_Tech_Store_v1/assets/IMG/jogo-mortal-kombat-11-ps4-6bba1909.webp" width="195">
        </div>
      </div>
      ...
      <form method="post" action="" id="add-to-cart-form">
        ...
        ?>
        <input type="hidden" name="product_id" value="104"> <!-- Change the value to the appropriate product ID -->
        <input type="hidden" name="price" value="99,10"> <!-- Change the value to the appropriate price -->
        <input type="hidden" name="picture" value="../Online_Tech_Store_v1/assets/IMG/jogo-mortal-kombat-11-ps4-6bba1909.webp">
